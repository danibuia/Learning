...
const Project = () => {
    ...
    const addMember = (email, position, firstName, lastName, linkedIn, facebook, avatar, token) => {
        axios
    ...
    const deleteMember = (memberId, token) => {
        axios
        ...
        <>
            <Grid container sx={{ display: 'flex', justifyContent: 'center' }}>
                <Grid item md={3}>
                    ...
                    <DeleteMembers deleteMemberById={deleteMember}
                        memberIdProps={memberIdProps}
                        setMemberIdProps={setMemberIdProps} />
                </Grid>
                <Grid item md={9} sx={{ display: 'flex', justifyContent: 'center' }}>
                    <Table  updatedMembers={updatedMembers} setMemberIdProps={setMemberIdProps} />
                </Grid>
            </Grid>
        </>
    )
